...
const int MAX_SEQUENCE_ITEMS =
    /*128*/ 252; // TODO: need to check if this exports correctly
...
// Maximum number of DPCM samples, cannot be increased unless the NSF driver is
// modified.
...
// Maximum numbers of tracks allowed (NSF limit is 256, but dunno if the
// bankswitcher can handle that)
...
// Max allowed value in volume column. The actual meaning is no specific volume
// information, rather than max volume.
...
const effect_t FDS_EFFECTS[] = {EF_FDS_MOD_DEPTH, EF_FDS_MOD_SPEED_HI,
                                EF_FDS_MOD_SPEED_LO, EF_FDS_VOLUME,
                                EF_FDS_MOD_BIAS};
// const effect_t MMC5_EFFECTS[] = {};
const effect_t N163_EFFECTS[] = {EF_N163_WAVE_BUFFER};
const effect_t S5B_EFFECTS[] = {EF_SUNSOFT_ENV_TYPE, EF_SUNSOFT_ENV_HI,
                                EF_SUNSOFT_ENV_LO, EF_SUNSOFT_NOISE};
